...
import { Usuario, PerfilUsuario } from "../models/item-usuarios";
...
export class AuthService {
    ...
    login(email: string, senha: string): boolean {
        ...
        const perfil: PerfilUsuario = email === 'admin@gmail.com' ? 'admin' : 'usuario';
        const usuarioLogado = {
            email,
            perfil,
            assinante: false
    ...
    obterAssinatura(): boolean {
        return this.usuario()?.assinante ?? false;
    }
